part of stagexl_rockdot.core;
	 ...
	 class Languages 
	{
		...
		//GREEK
		 static const String GREEK = "gr";
		
		//these use system fonts:
		 static const String TAIWANESE = "tw";
