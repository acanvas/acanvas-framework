 ...
 * @inheritDoc
 */
class UGCModelInjector implements IObjectPostProcessor {
  IObjectFactory _applicationContext;

  UGCModelInjector(IObjectFactory applicationContext) {
  ...
  dynamic postProcessAfterInitialization(dynamic object, String objectName) {
    if (object is IUGCModelAware) {
      object.ugcModel = _applicationContext.getObject(UGCPlugin.MODEL_UGC);
    }
