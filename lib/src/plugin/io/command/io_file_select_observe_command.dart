...
class IOFileSelectObserveCommand extends RdCommand {
  ...
  void createImageElement(String base64) {
    ...
    html.ImageElement originalImg =
        new html.ImageElement(); //querySelector("#originImg");
  ...
  void scale(html.ImageElement imageElement) {
    ...
    BitmapData sourceBitmapData =
        new BitmapData.fromImageElement(imageElement /*, 1/SCALE*/);
    ...
    targetBitmapData.draw(sourceBitmapData,
        new Matrix(_vo.scaleImage, 0, 0, _vo.scaleImage, 0, 0));
    ...
    if (_vo.watermark != null) {
      ...
      targetBitmapData.draw(logo,
          new Matrix(_vo.scaleWatermark, 0, 0, _vo.scaleWatermark, tx, ty));
    }
