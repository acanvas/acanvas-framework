  ...
  void execute([RdSignal event = null]) {
    ...
    if (_vo.inTarget != null && _vo.transitionType != ScreenConstants.TRANSITION_MODAL_BACK) {
      ...
      compositeCommand.addCommandEvent(
          new RdSignal(ScreenDisplaylistEvents.SCREEN_LOAD, _vo.inTarget), applicationContext);
      compositeCommand.addCommandEvent(
          new RdSignal(ScreenDisplaylistEvents.SCREEN_INIT, _vo.inTarget), applicationContext);
    }
    ...
    switch (_vo.transitionType) {
        ...
        compositeCommand.addCommandEvent(
            new RdSignal(
                ...
                new ScreenDisplaylistTransitionApplyVO(
                    _vo.effect, ScreenConstants.EFFECT_IN, _vo.inTarget, _vo.effect.duration)),
            applicationContext);
        break;
      case ScreenConstants.TRANSITION_NORMAL_TO_NORMAL:
        compositeCommand.addCommandEvent(
            new RdSignal(
                ScreenDisplaylistEvents.DISAPPEAR, new ScreenDisplaylistAppearDisappearVO(_vo.outTarget, 0.0, false)),
            applicationContext);
        compositeCommand.addCommandEvent(
            new RdSignal(
                TRANSITION_APPLY,
                new ScreenDisplaylistTransitionApplyVO(
                    _vo.effect, _vo.effect.type, _vo.outTarget, _vo.effect.duration, _vo.inTarget)),
            applicationContext);
        break;
      case ScreenConstants.TRANSITION_NORMAL_TO_MODAL:
        _uiService.blur();
      ...
      case ScreenConstants.TRANSITION_MODAL_BACK:
        ...
        compositeCommand.addCommandEvent(
            new RdSignal(
                ...
                new ScreenDisplaylistTransitionApplyVO(
                    _vo.effect,
                    ScreenConstants.EFFECT_OUT,
                    _uiService.layer.getChildAt(_uiService.layer.numChildren - 1) as LifecycleSprite,
                    _vo.effect.duration),
                _destroyLayer),
            applicationContext);
        break;
      case ScreenConstants.TRANSITION_MODAL_TO_NORMAL:
        ...
        compositeCommand.addCommandEvent(
            new RdSignal(ScreenDisplaylistEvents.DISAPPEAR, new ScreenDisplaylistAppearDisappearVO(layer, 0.0, false)),
            applicationContext);
        ...
        compositeCommand.addCommandEvent(
            new RdSignal(ScreenDisplaylistEvents.APPLY_EFFECT_OUT,
                new ScreenDisplaylistEffectApplyVO(effect, layer, _vo.effect.duration), _destroyLayer),
            applicationContext);
        compositeCommand.addCommandEvent(
            new RdSignal(
                TRANSITION_APPLY,
    ...
    compositeCommand.addCommandEvent(
        new RdSignal(
            ScreenDisplaylistEvents.APPEAR, new ScreenDisplaylistAppearDisappearVO(_vo.inTarget, _vo.effect.duration)),
        applicationContext);
